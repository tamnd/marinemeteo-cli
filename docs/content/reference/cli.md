...
```
marinemeteo <command> [arguments] [flags]
```

Run `marinemeteo <command> --help` for the full flag list on any command. This
...
per operation you declare in `marinemeteo/domain.go`.
