...
Most of these come down to network reality or how marinemeteo serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

marinemeteo rate-limits like any public site. marinemeteo already paces
...
Where a surface is gated, marinemeteo reads a cookie or token you supply
...
`marinemeteo`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what marinemeteo actually did
