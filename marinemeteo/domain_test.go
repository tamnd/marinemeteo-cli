...
// HTTP behaviour is covered in marinemeteo_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "marinemeteo://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("marinemeteo", "about")
	if err != nil || got.String() != "marinemeteo://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want marinemeteo://page/about", got.String(), err)
	}
}
